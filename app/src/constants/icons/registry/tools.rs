...
pub mod helix {
  ...
  pub const fn local() -> Icon {
    base().via_local("icons/logos/helix.svg")
  }
  #[must_use]
  pub fn filled() -> Icon {
    base().via_leptos(icon::SiHelix).colored("brand-helix")
  }
  #[must_use]
...
pub mod ohmyposh {
  ...
  #[must_use]
  pub const fn local() -> Icon {
    base().via_local("icons/logos/ohmyposh.svg")
  }
  #[must_use]
...
pub mod starship {
  ...
  #[must_use]
  pub const fn local() -> Icon {
    base().via_local("icons/logos/starship.svg")
  }
  #[must_use]
  pub fn filled() -> Icon {
    base()
...
pub mod typst {
  ...
  #[must_use]
  pub const fn local() -> Icon {
    base().via_local("icons/logos/typst.svg")
  }
  #[must_use]
  pub fn filled() -> Icon {
    base().via_leptos(icon::SiTypst).colored("brand-typst")
  }
  #[must_use]
  pub fn outlined() -> Icon {
    filled()
...
pub mod vscode {
  ...
  #[must_use]
  pub const fn local() -> Icon {
    base().via_local("icons/logos/vscode.svg")
  }
  #[must_use]
  pub fn filled() -> Icon {
    base().via_leptos(icon::VsVscode).colored("brand-vscode")
  }
  #[must_use]
  pub fn outlined() -> Icon {
    base()
...
pub mod vscodium {
  ...
  #[must_use]
  pub fn outlined() -> Icon {
    base().via_leptos(icon::VsCodeOss).colored("brand-vscodium")
  }
  #[must_use]
  pub fn default() -> Icon {
    filled()
...
pub mod zed {
  ...
  #[must_use]
  pub const fn local() -> Icon {
    base().via_local("icons/logos/zed.svg")
  }
  #[must_use]
  pub fn filled() -> Icon {
    base()
