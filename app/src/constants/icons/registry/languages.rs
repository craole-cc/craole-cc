...
pub mod bash {
  ...
  pub const fn local() -> Icon {
    base().via_local("icons/logos/bash.svg")
  }
  #[must_use]
  pub fn filled() -> Icon {
    base().via_leptos(icon::SiGnubash).colored("brand-bash")
  }
  #[must_use]
  pub fn outlined() -> Icon {
    base().via_leptos(icon::MdiBash).colored("brand-bash")
  }
  #[must_use]
  pub fn default() -> Icon {
    filled()
...
pub mod javascript {
  ...
  #[must_use]
  pub const fn local() -> Icon {
    base().via_local("icons/logos/javascript.svg")
  }
  #[must_use]
  pub fn filled() -> Icon {
    base()
...
pub mod nushell {
  ...
  #[must_use]
  pub const fn local() -> Icon {
    base().via_local("icons/logos/nushell.svg")
  }
  #[must_use]
  pub fn filled() -> Icon {
    base().via_leptos(icon::SiNushell).colored("brand-nushell")
  }
  #[must_use]
  pub fn outlined() -> Icon {
    filled()
...
pub mod posix {
  ...
  #[must_use]
  pub const fn local() -> Icon {
    base().via_local("icons/logos/posix-shell.svg")
  }
  #[must_use]
  pub fn filled() -> Icon {
    base().via_leptos(icon::SiGnubash).colored("brand-posix")
  }
  #[must_use]
  pub fn outlined() -> Icon {
    base().via_leptos(icon::MdiBash).colored("brand-posix")
  }
  #[must_use]
  pub fn default() -> Icon {
    filled()
...
pub mod powershell {
  ...
  #[must_use]
  pub const fn local() -> Icon {
    base().via_local("icons/logos/powershell.svg")
  }
  #[must_use]
  pub fn filled() -> Icon {
    base()
...
pub mod python {
  ...
  #[must_use]
  pub const fn local() -> Icon {
    base().via_local("icons/logos/python.svg")
  }
  #[must_use]
  pub fn filled() -> Icon {
    base().via_leptos(icon::SiPython).colored("brand-python")
  }
  #[must_use]
  pub fn outlined() -> Icon {
    base()
...
pub mod rust {
  ...
  #[must_use]
  pub const fn local() -> Icon {
    base().via_local("icons/logos/rust.svg")
  }
  #[must_use]
  pub fn filled() -> Icon {
    base().via_leptos(icon::SiRust).colored("brand-rust")
  }
  #[must_use]
  pub fn outlined() -> Icon {
    base()
...
pub mod typescript {
  ...
  #[must_use]
  pub const fn local() -> Icon {
    base().via_local("icons/logos/typescript.svg")
  }
  #[must_use]
  pub fn filled() -> Icon {
    base()
...
pub mod zig {
  ...
  #[must_use]
  pub const fn local() -> Icon {
    base().via_local("icons/logos/zig.svg")
  }
  #[must_use]
  pub fn filled() -> Icon {
    base().via_leptos(icon::SiZig).colored("brand-zig")
  }
  #[must_use]
  pub fn outlined() -> Icon {
    filled()
