...
pub mod gmail {
  ...
  #[must_use]
  pub fn filled() -> Icon {
    base().via_leptos(icon::MdiGmail).colored("brand-gmail")
  }
  #[must_use]
  pub fn outlined() -> Icon {
    base()
  ...
  #[must_use]
  pub fn fa_brands() -> Icon {
    base().via_leptos(icon::BiGmail).colored("brand-gmail")
  }
  #[must_use]
  pub fn default() -> Icon {
    filled()
...
pub mod x {
  ...
  #[must_use]
  pub fn fa_brands() -> Icon {
    base().via_leptos(icon::FaXTwitterBrands).colored("brand-x")
  }
  #[must_use]
  pub fn fa_square() -> Icon {
    base()
