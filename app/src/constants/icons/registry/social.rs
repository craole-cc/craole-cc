...
pub mod facebook_variants {
  ...
  pub fn local() -> Source {
    Source::Local("icons/logos/facebook.svg")
  }

  pub fn filled() -> Source {
    Source::Leptos(icon::RiFacebookBoxLogosFill)
  }

  pub fn outlined() -> Source {
    Source::Leptos(icon::RiFacebookBoxLogosLine)
  }

  pub fn fa_brands() -> Source {
    Source::Leptos(icon::FaFacebookFBrands)
  }

  pub fn fa_square() -> Source {
    Source::Leptos(icon::FaSquareFacebookBrands)
  }
...
pub mod gmail_variants {
  ...
  pub fn local() -> Source {
    Source::Local("icons/logos/gmail.svg")
  }
  pub fn filled() -> Source {
    Source::Leptos(icon::MdiGmail)
  }
  pub fn outlined() -> Source {
    Source::Leptos(icon::TbBrandGmailOutline)
  }
  pub fn fa_brands() -> Source {
    Source::Leptos(icon::BiGmail)
  }
  pub fn fa_square() -> Source {
    Source::Leptos(icon::BiGmail)
  }
...
pub mod instagram_variants {
  ...
  pub fn local() -> Source {
    Source::Local("icons/logos/instagram.svg")
  }
  pub fn filled() -> Source {
    Source::Leptos(icon::RiInstagramLogosFill)
  }
  pub fn outlined() -> Source {
    Source::Leptos(icon::RiInstagramLogosLine)
  }
  pub fn fa_brands() -> Source {
    Source::Leptos(icon::FaInstagramBrands)
  }
  pub fn fa_square() -> Source {
    Source::Leptos(icon::FaSquareInstagramBrands)
  }
...
pub mod linkedin_variants {
  ...
  pub fn local() -> Source {
    Source::Local("icons/logos/linkedin.svg")
  }
  pub fn filled() -> Source {
    Source::Leptos(icon::RiLinkedinBoxLogosFill)
  }
  pub fn outlined() -> Source {
    Source::Leptos(icon::RiLinkedinBoxLogosLine)
  }
  pub fn fa_brands() -> Source {
    Source::Leptos(icon::FaLinkedinInBrands)
  }
  pub fn fa_square() -> Source {
    Source::Leptos(icon::FaLinkedinBrands)
  }
...
pub mod whatsapp_variants {
  ...
  pub fn local() -> Source {
    Source::Local("icons/logos/whatsapp.svg")
  }

  pub fn filled() -> Source {
    Source::Leptos(icon::RiWhatsappLogosFill)
  }

  pub fn outlined() -> Source {
    Source::Leptos(icon::RiWhatsappLogosLine)
  }

  pub fn fa_brands() -> Source {
    Source::Leptos(icon::FaWhatsappBrands)
  }

  pub fn fa_square() -> Source {
    Source::Leptos(icon::FaSquareWhatsappBrands)
  }
...
pub mod x_variants {
  ...
  pub fn local() -> Source {
    Source::Local("icons/logos/x.svg")
  }

  pub fn filled() -> Source {
    Source::Leptos(icon::RiTwitterXLogosFill)
  }

  pub fn outlined() -> Source {
    Source::Leptos(icon::RiTwitterXLogosLine)
  }

  pub fn fa_brands() -> Source {
    Source::Leptos(icon::FaXTwitterBrands)
  }

  pub fn fa_square() -> Source {
    Source::Leptos(icon::FaSquareXTwitterBrands)
  }
