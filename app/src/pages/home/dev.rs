  ...
  let categories = vec![
    Stack {
      ...
      technologies: vec![
        ...
        Tech {
          name: "Shell",
          logo: "https://cdn.simpleicons.org/gnubash/036882",
    ...
    Stack {
      ...
      technologies: vec![
        Tech {
          name: "Axum",
          logo: "https://avatars.githubusercontent.com/u/20248544?s=48&v=4",
  ...
  view! {
    <section id="tech-stack" class="mb-20">
      ...
      <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
        {categories
          .into_iter()
          .map(|cat| view! { <Stack category=cat /> })
          .collect::<Vec<_>>()}
      </div>
    </section>
  }
...
fn Stack(category: Stack) -> impl IntoView {
  view! {
    <div class="p-5 border rounded-lg bg-slate-50 dark:bg-slate-800/30 border-slate-200 dark:border-slate-700/50">
...
fn Badge(tech: Tech) -> impl IntoView {
  view! {
    <a
      ...
      class="flex items-center gap-2 px-3 py-2 transition-all bg-white border rounded-lg group hover:shadow-md hover:scale-105 dark:bg-slate-800 border-slate-300 dark:border-slate-600 hover:border-blue-400 dark:hover:border-blue-500"
    >
      <img
        src=tech.logo
        alt=tech.name
...
fn Area(area: Area) -> impl IntoView {
  view! {
    <div class="p-6 transition-all duration-300 border rounded-xl hover:shadow-lg bg-white/80 dark:bg-slate-800/50 border-slate-200 dark:border-slate-700/50">
