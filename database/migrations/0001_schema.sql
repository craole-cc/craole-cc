...
CHECK (status IN ('active', 'building', 'planning', 'archived')),
repo_url TEXT,
live_url TEXT,
readme_html TEXT,
screenshots TEXT,
...
AFTER INSERT ON projects WHEN NEW.published = 1
BEGIN
...
AFTER INSERT ON media WHEN NEW.published = 1
BEGIN
...
AFTER INSERT ON posts WHEN NEW.published = 1
BEGIN
